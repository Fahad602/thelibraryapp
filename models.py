...
class UserList(db.Model):
    ...
    f_name = db.Column(db.String(255), unique = False, nullable = False)
    l_name = db.Column(db.String(255),  unique = False, nullable = False)
    user_id = db.Column(db.String(255), unique = False, nullable = False)
    year = db.Column(db.String(255), nullable=False)
    
    
    def __init__(self,  email, f_name, l_name, user_id, year):
        self.email = email
        self.f_name = f_name
        self.l_name = l_name
